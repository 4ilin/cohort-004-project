...
- Testing and deployment`,
  ...
  // ─── Course Ratings ───
  // Ratings from enrolled students who have made meaningful progress:
  // - Course 1: Emma (5), James (4), Sophia (5) — avg 4.7
  // - Course 2: Emma (4), Olivia (3) — avg 3.5
  ...
  console.log("Created 5 course ratings.");
